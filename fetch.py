#!/usr/bin/env python3
"""
Recuperation des codes promo Dyson depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/dyson.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/dyson.fr"
STORE_NAME = "Dyson"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Dyson depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-dyson)"
    }
    try:
